...
// Importa a tela usada para cadastrar uma nova tarefa.
import 'package:taskflow/ui/task_form/task_form_screen.dart';

// Declara a tela inicial com estado mutável para atualizar a lista.
class HomeScreen extends StatefulWidget {
  // Cria a tela inicial e permite o recebimento opcional de uma chave.
  const HomeScreen({super.key});

  // Cria o objeto responsável por armazenar o estado da tela.
  @override
  State<HomeScreen> createState() => _HomeScreenState();
} // Encerra a declaração do widget HomeScreen.

// Implementa o estado mutável da tela inicial.
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Abre o formulário e aguarda uma possível nova tarefa.
  Future<void> _openTaskForm() async {
    // Navega para o formulário e recebe a tarefa retornada ao salvar.
    final task = await Navigator.of(context).push<Task>(
      // Cria a rota Material que apresenta a tela de formulário.
      MaterialPageRoute(builder: (context) => const TaskFormScreen()),
    ); // Encerra a navegação e atribui o resultado.
    ...
    ScaffoldMessenger.of(context)
      ...
      ..showSnackBar(
        // Cria a mensagem de sucesso exibida na parte inferior da tela.
        const SnackBar(content: Text('Tarefa cadastrada com sucesso!')),
      ); // Encerra a exibição do SnackBar.
  } // Encerra o método que abre o formulário.

  // Constrói a interface atual da tela inicial.
  @override
  Widget build(BuildContext context) {
    // Retorna a estrutura visual básica da página.
    return Scaffold(
      // Cria a barra superior com o nome do aplicativo.
      appBar: AppBar(title: const Text('TaskFlow')),
      // Cria uma lista rolável com separadores entre as tarefas.
      body: ListView.separated(
        ...
        // Constrói um TaskCard para a tarefa localizada no índice atual.
  ...
  } // Encerra a construção da tela inicial.
} // Encerra a declaração do estado da HomeScreen.
